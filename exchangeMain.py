...
urlList = [line.rstrip('\n') for line in open('exchangeURL.txt')]  # Reads a list of urls from exchangeURL.txt
outputFile = open("outputExchange.csv", "w+")  # Opens the output file
...
for link in urlList:
    ...
    imgUploadedBase = "http://localhost:8888/en/wp-content/uploads/2017/01/"
    ...
    if len(imgList) == 0:
        outputFile.write("http://localhost:8888/en/wp-content/uploads/2016/12/placeholder_600x400.png" + ";")
    outputFile.write("\n")
