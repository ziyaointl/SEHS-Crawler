...
class PageRedirectTests(unittest.TestCase):
    ...
    def test_messageExistsLocationExists(self):
        ...
        """
        e = error.PageRedirect(b"200", b"My own message", location=b"/outputFile")
        self.assertEqual(e.message, b"My own message to /outputFile")
...
class InfiniteRedirectionTests(unittest.TestCase):
    ...
    def test_noMessageValidStatus(self):
        ...
        assigned.
        """
        e = error.InfiniteRedirection(b"200", location=b"/outputFile")
        self.assertEqual(e.message, b"OK to /outputFile")
    ...
    def test_noMessageInvalidStatusLocationExists(self):
        ...
        L{None}.
        """
        e = error.InfiniteRedirection(b"InvalidCode", location=b"/outputFile")
        self.assertEqual(e.message, None)
