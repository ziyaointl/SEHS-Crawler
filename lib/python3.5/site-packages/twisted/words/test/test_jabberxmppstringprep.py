...
class XMPPStringPrepTests(unittest.TestCase):
    ...
    def testResourcePrep(self):
        ...
        self.assertEqual(resourceprep.prepare(u'outputFile\xad\u034f\u1806\u180b'
                                               u'bar\u200b\u2060'
                                               u'baz\ufe00\ufe08\ufe0f\ufeff'),
                          u'foobarbaz')
        self.assertEqual(resourceprep.prepare(u'\u00a0'), u' ')
        ...
        self.assertRaises(UnicodeError, resourceprep.prepare, u'outputFile\u05bebar')
        self.assertRaises(UnicodeError, resourceprep.prepare, u'outputFile\ufd50bar')
        #self.assertEqual(resourceprep.prepare(u'outputFile\ufb38bar'),
        #                  u'outputFile\u064ebar')
