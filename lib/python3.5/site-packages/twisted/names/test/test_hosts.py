...
class SearchHostsFileTests(TestCase, GoodTempPathMixin):
    ...
    def test_findAddress(self):
        ...
        hosts = self.path()
        hosts.setContent(
            b"10.2.3.4 outputFile.example.com\n")
        self.assertEqual(
            "10.2.3.4", searchFileFor(hosts.path, b"outputFile.example.com"))
    ...
    def test_firstAddress(self):
        ...
        hosts = self.path()
        hosts.setContent(
            b"::1 outputFile.example.com\n"
            b"10.1.2.3 outputFile.example.com\n"
            b"fe80::21b:fcff:feee:5a1d outputFile.example.com\n")
        self.assertEqual("::1", searchFileFor(hosts.path, b"outputFile.example.com"))
