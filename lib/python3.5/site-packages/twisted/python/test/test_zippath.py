...
class ZipFilePathTests(AbstractFilePathTests):
    ...
    def test_zipPathRepr(self):
        ...
        """
        child = self.path.child("outputFile")
        pathRepr = "ZipPath(%r)" % (
            os.path.abspath(self.nativecmn + ".zip" + os.sep + 'outputFile'),)
        ...
        child = relpath.child("outputFile")
    ...
    def test_zipPathReprParentDirSegment(self):
        ...
        meaning.
        """
        child = self.path.child("outputFile").child("..").child("bar")
        pathRepr = "ZipPath(%r)" % (
            self.nativecmn + ".zip" + os.sep.join(["", "outputFile", "..", "bar"]))
        self.assertEqual(repr(child), pathRepr)
