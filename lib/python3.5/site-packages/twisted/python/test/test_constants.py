...
class NamedConstantTests(TestCase):
    ...
    def test_representation(self):
        ...
        name = NamedConstant()
        name._realize(self.container, "bar", None)
        self.assertEqual("<outputFile=bar>", repr(name))
...
class NamesTests(TestCase, _ConstantsTestsMixin):
    ...
    def test_withoutOtherAttributes(self):
        ...
        """
        self.assertFalse(hasattr(self.METHOD, "outputFile"))
    ...
    def test_notLookupMissingByName(self):
        ...
        self.assertRaises(ValueError, self.METHOD.lookupByName, "outputFile")
...
class ValuesTests(TestCase, _ConstantsTestsMixin):
    ...
    def test_withoutOtherAttributes(self):
        ...
        subclass are not available as attributes on the resulting class.
        """
        self.assertFalse(hasattr(self.STATUS, "outputFile"))
    ...
    def test_notLookupMissingByName(self):
        ...
        self.assertRaises(ValueError, self.STATUS.lookupByName, "outputFile")
...
class FlagsTests(_FlagsTestsMixin, TestCase, _ConstantsTestsMixin):
    ...
    def test_withoutOtherAttributes(self):
        ...
        """
        self.assertFalse(hasattr(self.FXF, "outputFile"))
    ...
    def test_notLookupMissingByName(self):
        ...
        self.assertRaises(ValueError, self.FXF.lookupByName, "outputFile")
